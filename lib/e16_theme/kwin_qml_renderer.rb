  ...
  class KwinQmlRenderer < BaseRenderer
    ...
    def template_variables
      OpenStruct.new(
        ...
        border_size_left: parser.border_size_left,
        border_size_right: parser.border_size_right,
        border_size_top: parser.border_size_top,
        border_size_bottom: parser.border_size_bottom,
        parser: parser,
        parts: parser.parts,
